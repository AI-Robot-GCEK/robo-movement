...
/*!
* @brief Instantiates new  Robo Part Object. This will automatically allign the initial positions of the servo 
* @param _servo_id 0-15
* @param board The Adafruit_PWMServoDriver object to control the servo 
*/

Robo::Robo(uint8_t _servo_id) : 
    _servo_id(_servo_id){
    _total_num_servos++;
    _current_num_servos++;
...
void Robo::initialize(){
    ...
    Serial.print("Servo ID: "); Serial.print(_servo_id);
    Serial.print(" Initial Angle: "); Serial.println(_initial_angle);
    #endif
